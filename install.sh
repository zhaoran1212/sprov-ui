...
install_sprov-ui() {
    ...
    wget -N --no-check-certificate -O /usr/local/sprov-ui/sprov-ui.jar https://github.com/LuisLIn666/sprov-ui/releases/download/${last_version}/sprov-ui-${last_version}.jar
    if [[ $? -ne 0 ]]; then
